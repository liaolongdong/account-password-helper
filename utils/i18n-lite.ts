...
export const LITE_MESSAGES: Record<LiteLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'cs.inline.matchPortDiff': '端口不同',
    'cs.inline.matchSubDomain': '其他子域',
    'cs.inline.matchMainDomain': '主域名',
    'cs.inline.matchApprox': '近似匹配',
  ...
  en: {
    ...
    'cs.inline.matchPortDiff': 'Other port',
    'cs.inline.matchSubDomain': 'Other subdomain',
    'cs.inline.matchMainDomain': 'Main domain',
    'cs.inline.matchApprox': 'Approximate',
