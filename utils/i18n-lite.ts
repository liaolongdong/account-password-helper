...
export const LITE_MESSAGES: Record<LiteLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'cs.save.noteUpdateOtherHost': '将更新 {url} 的同名账号',
    'cs.save.noteWillCreate': '库中已有 {url} 的同名账号，本次将新增一条',
    'cs.inline.trigger': '快速填充',
    'cs.inline.lockedTitle': '解锁后填充',
    'cs.inline.lockedDesc': '点击验证主密码以使用快速填充',
    'cs.inline.noMasterTitle': '请先设置主密码',
    'cs.inline.noMasterDesc': '需要先设置主密码才能使用密码填充功能',
    'cs.inline.noMasterAction': '前往设置',
    'cs.inline.searchPlaceholder': '搜索账号、标签、备注、网址...',
    'cs.inline.listboxLabel': '匹配账号列表',
    'cs.inline.manage': '密码管理',
    'cs.inline.emptyNoAccounts': '当前网站暂无匹配账号',
    'cs.inline.emptyNoMatch': '未找到匹配的账号',
    'cs.inline.emptyAddSite': '添加此网站账号',
    'cs.inline.searchAllHint': '到全部账号中搜索「{keyword}」',
    'cs.inline.moreRowsHint': '本站匹配还有 {count} 条未显示，到管理页查看全部',
    ...
    'cs.inline.totpShow': '显示两步验证码',
    'cs.inline.totpLoading': '获取中',
    'cs.inline.totpCopyTitle': '点击复制验证码',
    'cs.inline.totpFill': '填入页面验证码输入框',
    'cs.inline.totpCopied': '已复制',
    'cs.inline.totpFailed': '验证码获取失败',
    'cs.handoff.capsuleTitle': '刚填充的账号已开启两步验证，点击复制动态码',
    'cs.handoff.fillTitle': '填入页面验证码输入框',
    'cs.handoff.closeTitle': '本次不再提示',
    ...
    // F1-C: Fill failure prompt
    'cs.fd.failurePromptText': '未检测到登录表单？→ 手动指定选择器',
    'cs.fd.failurePromptSpecify': '指定选择器',
    'cs.fd.failurePromptLater': '稍后再说',
    'cs.fd.failurePromptGuide': '点击「指定选择器」，在站点规则中为该站点填写账号与密码输入框的选择器。',
    ...
    'bg.autoSave.tooLong': '账号、密码或备注过长，请精简后重试',
    'bg.autoSave.capacityReached': '账号密码条目数已达上限（{max} 条），本次未保存。请先删除不再需要的条目',
    ...
    'bg.quickAdd.capacityReached': '条目总数已达上限（{max} 条），未能添加',
  ...
  en: {
    ...
    'cs.save.noteUpdateOtherHost': 'This will update the same account saved for {url}',
    'cs.save.noteWillCreate': 'The same account already exists for {url} — this will create a new entry',
    ...
    'cs.inline.noMasterTitle': 'Set up master password first',
    'cs.inline.noMasterDesc': 'Master password is required to use password fill',
    'cs.inline.noMasterAction': 'Go to settings',
    'cs.inline.searchPlaceholder': 'Search account, tag, note, URL...',
    'cs.inline.listboxLabel': 'Matching accounts',
    ...
    'cs.inline.emptyAddSite': 'Add account for this site',
    'cs.inline.searchAllHint': 'Search all accounts for "{keyword}"',
    'cs.inline.moreRowsHint': '{count} more matches on this site are hidden — view all in the manager',
    'cs.inline.scopeCrossSubdomain': 'Cross-subdomain',
    ...
    'cs.inline.totpShow': 'Show 2FA code',
    'cs.inline.totpLoading': 'Loading',
    'cs.inline.totpCopyTitle': 'Click to copy the code',
    'cs.inline.totpFill': 'Fill the page code input',
    'cs.inline.totpCopied': 'Copied',
    'cs.inline.totpFailed': 'Failed to get the code',
    'cs.handoff.capsuleTitle': 'The account you just filled has 2FA on — click to copy the code',
    'cs.handoff.fillTitle': 'Fill the page code input',
    'cs.handoff.closeTitle': "Don't show again this time",
    ...
    // F1-C: Fill failure prompt
    'cs.fd.failurePromptText': 'No login form detected? → Specify selectors manually',
    'cs.fd.failurePromptSpecify': 'Specify Selectors',
    'cs.fd.failurePromptLater': 'Later',
    'cs.fd.failurePromptGuide':
      'Click "Specify Selectors" to enter the account and password field selectors for this site in Site-Fill Rules.',
    ...
    'bg.autoSave.tooLong': 'Username, password or remark is too long. Please shorten it and retry.',
    'bg.autoSave.capacityReached':
      'The entry limit ({max}) has been reached, so this password was not saved. Delete entries you no longer need first.',
    ...
    'bg.quickAdd.capacityReached': 'The entry limit ({max}) has been reached, so the entry was not added.',
