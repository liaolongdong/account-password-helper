...
export const LITE_MESSAGES: Record<LiteLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'cs.fd.shadowScanTimeout': 'Shadow DOM 扫描超时（300ms），跳过以保障性能',
    ...
    'cs.fd.failurePromptDialogTitle': '指定 CSS 选择器',
    'cs.fd.failurePromptDialogHint': '请输入用户名/密码字段的 CSS 选择器',
    'cs.fd.failurePromptValidateSelector': '请选择有效的 CSS 选择器',
    'cs.fd.failurePromptSaveSuccess': '规则已保存',
    'cs.fd.failurePromptSaveError': '保存失败，请重试',
  ...
  en: {
    ...
    'cs.fd.shadowScanTimeout': 'Shadow DOM scan timed out (300ms), skipped for performance',
    ...
    'cs.fd.failurePromptDialogTitle': 'Specify CSS Selectors',
    'cs.fd.failurePromptDialogHint': 'Enter CSS selectors for username/password fields',
    'cs.fd.failurePromptValidateSelector': 'Please enter a valid CSS selector',
    'cs.fd.failurePromptSaveSuccess': 'Rule saved',
    'cs.fd.failurePromptSaveError': 'Failed to save, please retry',
