 ...
 */
test.describe('密码条目增删改（待按扩展夹具重写）', () => {
  test.skip(true, 'TODO: 需按 e2e/harness.ts 的扩展夹具重写后才能运行');
  // TODO: should add a new password entry
  // TODO: should edit an existing password
  // TODO: should delete a password
  // TODO: should filter passwords by search
  // TODO: should toggle password visibility
  // TODO: should favorite a password
});
