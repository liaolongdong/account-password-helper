 ...
 */
test.describe('会话管理（待按扩展夹具重写）', () => {
  test.skip(true, 'TODO: 需按 e2e/harness.ts 的扩展夹具重写后才能运行');
  // TODO: should show session expiry timer
  // TODO: should open validity settings when clicking session chip
  // TODO: should adjust session validity hours
  // TODO: should clear session on logout
  // TODO: should auto-lock after idle time
});
